    ...
    <div className='flex flex-col md:flex-row'>
      <div className='p-7 border-b md:border-r md:min-h-screen border-gray-500'>
        <form className='flex flex-col gap-8' onSubmit={handleSubmit}>
          ...
          <div className='flex items-center gap-2'>
            <label className='font-semibold'>Sorteaza:</label>
          ...
          <div className='flex items-center gap-2'>
            ...
            <Select
              ...
              id='category'
            >
              <option value='uncategorized'>Nicio categorie</option>
      ...
      <div className='w-full'>
        ...
        <div className='p-7 flex flex-wrap gap-4'>
          {!loading && posts.length === 0 && (
            <p className='text-xl text-gray-500'>Nicio postare gasita.</p>
          )}
          {loading && <p className='text-xl text-gray-500'>Se incarca...</p>}
          {!loading &&
            posts &&
